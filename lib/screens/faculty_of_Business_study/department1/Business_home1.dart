...
import 'package:flutter_downloader_example/screens/faculty_of_Business_study/department1/select_yaer_bsc_assignment.dart';

import 'package:flutter_downloader_example/screens/faculty_of_Business_study/department1/select_yaer_bsc_tutorial.dart';

import 'package:hexcolor/hexcolor.dart';

class Businesshome1 extends StatefulWidget {
  const Businesshome1({Key? key}) : super(key: key);

  @override
  _Businesshome1State createState() => _Businesshome1State();
}

class _Businesshome1State extends State<Businesshome1> {
  @override
                ...
                Padding(
                  ...
                  child: Column(
                    children: [ Notificationpage(),
                      ...
                      Customelevated(
                          "Tutorial", HexColor("#FFCCBC"), Selectyearbsctdp1()),
                      SizedBox(
                        height: 30,
                      ),
                    ],
