...
class Selectyearassignmentdp2 extends StatefulWidget {
  final c;
  const Selectyearassignmentdp2(this.c);

  @override
  _Selectyearassignmentdp2State createState() =>
      _Selectyearassignmentdp2State(this.c);
}

class _Selectyearassignmentdp2State extends State<Selectyearassignmentdp2> {
  final c;
  _Selectyearassignmentdp2State(this.c);
