...
class Selectyeartechassignment extends StatefulWidget {
  const Selectyeartechassignment();

  @override
  _SelectyeartechassignmentState createState() =>
      _SelectyeartechassignmentState();
}

class _SelectyeartechassignmentState extends State<Selectyeartechassignment> {
  @override
